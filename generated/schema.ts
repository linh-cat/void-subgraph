...
export class Market extends Entity {
  ...
  get maintenanceMarginBps(): i32 {
    let value = this.get("maintenanceMarginBps");
    return value!.toI32();
  }

  set maintenanceMarginBps(value: i32) {
    this.set("maintenanceMarginBps", Value.fromI32(value));
  }

  get maxPostionSizeOverVault(): i32 {
    let value = this.get("maxPostionSizeOverVault");
    return value!.toI32();
  }

  set maxPostionSizeOverVault(value: i32) {
    this.set("maxPostionSizeOverVault", Value.fromI32(value));
  }

  get liquidationFeeRate(): i32 {
    let value = this.get("liquidationFeeRate");
    return value!.toI32();
  }

  set liquidationFeeRate(value: i32) {
    this.set("liquidationFeeRate", Value.fromI32(value));
  }

  get openFeeRate(): i32 {
    let value = this.get("openFeeRate");
    return value!.toI32();
  }

  set openFeeRate(value: i32) {
    this.set("openFeeRate", Value.fromI32(value));
  }

  get closeFeeRate(): i32 {
    let value = this.get("closeFeeRate");
    return value!.toI32();
  }

  set closeFeeRate(value: i32) {
    this.set("closeFeeRate", Value.fromI32(value));
  }

  get priceFeedType(): i32 {
    let value = this.get("priceFeedType");
    return value!.toI32();
  }

  set priceFeedType(value: i32) {
    this.set("priceFeedType", Value.fromI32(value));
  }
  ...
  get fundingRateModel(): Bytes {
    let value = this.get("fundingRateModel");
    return value!.toBytes();
  }

  set fundingRateModel(value: Bytes) {
    this.set("fundingRateModel", Value.fromBytes(value));
  }

  get fundingRatePrecision(): BigInt {
    let value = this.get("fundingRatePrecision");
    return value!.toBigInt();
  }

  set fundingRatePrecision(value: BigInt) {
    this.set("fundingRatePrecision", Value.fromBigInt(value));
  }
  ...
  get longFundingIndex(): BigInt | null {
    let value = this.get("longFundingIndex");
  ...
  set longFundingIndex(value: BigInt | null) {
    if (!value) {
      this.unset("longFundingIndex");
    } else {
      this.set("longFundingIndex", Value.fromBigInt(<BigInt>value));
    }
  }

  get shortFundingIndex(): BigInt | null {
    let value = this.get("shortFundingIndex");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set shortFundingIndex(value: BigInt | null) {
    if (!value) {
      this.unset("shortFundingIndex");
    } else {
      this.set("shortFundingIndex", Value.fromBigInt(<BigInt>value));
    }
  }

  get longPayoutIndex(): BigInt | null {
    let value = this.get("longPayoutIndex");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set longPayoutIndex(value: BigInt | null) {
    if (!value) {
      this.unset("longPayoutIndex");
    } else {
      this.set("longPayoutIndex", Value.fromBigInt(<BigInt>value));
    }
  }

  get shortPayoutIndex(): BigInt | null {
    let value = this.get("shortPayoutIndex");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBigInt();
  ...
  set shortPayoutIndex(value: BigInt | null) {
    if (!value) {
      this.unset("shortPayoutIndex");
    } else {
      this.set("shortPayoutIndex", Value.fromBigInt(<BigInt>value));
    }
  }
...
export class Position extends Entity {
  ...
  set entryPrice(value: BigInt | null) {
    if (!value) {
      this.unset("entryPrice");
    } else {
      this.set("entryPrice", Value.fromBigInt(<BigInt>value));
    }
  }

  get entryFundingIndex(): BigInt | null {
  ...
  set entryFundingIndex(value: BigInt | null) {
    if (!value) {
      this.unset("entryFundingIndex");
    } else {
      this.set("entryFundingIndex", Value.fromBigInt(<BigInt>value));
    }
  }

  get entryPayoutIndex(): BigInt | null {
  ...
  set entryPayoutIndex(value: BigInt | null) {
    if (!value) {
      this.unset("entryPayoutIndex");
    } else {
      this.set("entryPayoutIndex", Value.fromBigInt(<BigInt>value));
    }
  }
  ...
  get feeAndFundings(): Array<string> {
    let value = this.get("feeAndFundings");
...
export class FundingHistory extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FundingHistory entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type FundingHistory must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("FundingHistory", id.toString(), this);
    }
  }

  static load(id: string): FundingHistory | null {
    return changetype<FundingHistory | null>(store.get("FundingHistory", id));
  }
  ...
  get longFundingIndex(): BigInt {
    let value = this.get("longFundingIndex");
    return value!.toBigInt();
  }

  set longFundingIndex(value: BigInt) {
    this.set("longFundingIndex", Value.fromBigInt(value));
  }

  get shortFundingIndex(): BigInt {
    let value = this.get("shortFundingIndex");
    return value!.toBigInt();
  }

  set shortFundingIndex(value: BigInt) {
    this.set("shortFundingIndex", Value.fromBigInt(value));
  }

  get longPayoutIndex(): BigInt {
    let value = this.get("longPayoutIndex");
    return value!.toBigInt();
  }

  set longPayoutIndex(value: BigInt) {
    this.set("longPayoutIndex", Value.fromBigInt(value));
  }

  get shortPayoutIndex(): BigInt {
    let value = this.get("shortPayoutIndex");
    return value!.toBigInt();
  }

  set shortPayoutIndex(value: BigInt) {
    this.set("shortPayoutIndex", Value.fromBigInt(value));
  }

  get nInterval(): BigInt {
    let value = this.get("nInterval");
    return value!.toBigInt();
  }

  set nInterval(value: BigInt) {
    this.set("nInterval", Value.fromBigInt(value));
  }
...
export class FeeAndFunding extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save FeeAndFunding entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type FeeAndFunding must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("FeeAndFunding", id.toString(), this);
    }
  }

  static load(id: string): FeeAndFunding | null {
    return changetype<FeeAndFunding | null>(store.get("FeeAndFunding", id));
  }
