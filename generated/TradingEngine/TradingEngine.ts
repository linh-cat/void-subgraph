...
export class TradingEngine__addGovernedMarketInputAddressesStruct extends ethereum.Tuple {
  get owner(): Address {
...
export class TradingEngine__addGovernedMarketInputParamsStruct extends ethereum.Tuple {
  get name(): Bytes {
    return this[0].toBytes();
  }
...
export class TradingEngine__getFundingInfoResult {
  value0: BigInt;
  value1: BigInt;
  ...
  getFundingPayout(): BigInt {
    return this.value0;
  }

  getFundingDebt(): BigInt {
    return this.value1;
  }
}
...
export class TradingEngine__getPrevFundingStateResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class TradingEngine extends ethereum.SmartContract {
  ...
  addGovernedMarket(
    addresses: TradingEngine__addGovernedMarketInputAddressesStruct,
    params: TradingEngine__addGovernedMarketInputParamsStruct
  ): Bytes {
    let result = super.call(
      "addGovernedMarket",
      "addGovernedMarket((address,address,address,address,address,address,address),(bytes32,uint8[2],uint8[2],uint16,uint16,uint16,uint16,uint16,uint32,uint8,uint8,uint8,uint8,uint8,bool)):(bytes32)",
  ...
  getFundingInfo(
    marketId: Bytes,
    key: Bytes
  ): TradingEngine__getFundingInfoResult {
    let result = super.call(
      "getFundingInfo",
      "getFundingInfo(bytes32,bytes32):(uint256,uint256)",
      [
    ...
    return new TradingEngine__getFundingInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getFundingInfo(
    marketId: Bytes,
    key: Bytes
  ): ethereum.CallResult<TradingEngine__getFundingInfoResult> {
    let result = super.tryCall(
      "getFundingInfo",
      "getFundingInfo(bytes32,bytes32):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new TradingEngine__getFundingInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getPositionKey(
    ...
    let result = super.call(
      "getPositionKey",
      "getPositionKey(bytes32,address,address,bool):(bytes32)",
      [
        ethereum.Value.fromFixedBytes(marketId),
  ...
  getPrevFundingState(
    ...
    let result = super.call(
      "getPrevFundingState",
      "getPrevFundingState(bytes32):(uint256,uint256,uint256,int256)",
      [ethereum.Value.fromFixedBytes(marketKey)]
    );

    return new TradingEngine__getPrevFundingStateResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getPrevFundingState(
    marketKey: Bytes
  ): ethereum.CallResult<TradingEngine__getPrevFundingStateResult> {
    let result = super.tryCall(
      "getPrevFundingState",
      "getPrevFundingState(bytes32):(uint256,uint256,uint256,int256)",
      [ethereum.Value.fromFixedBytes(marketKey)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new TradingEngine__getPrevFundingStateResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
...
export class AddGovernedMarketCall extends ethereum.Call {
  get inputs(): AddGovernedMarketCall__Inputs {
    return new AddGovernedMarketCall__Inputs(this);
  }

  get outputs(): AddGovernedMarketCall__Outputs {
    return new AddGovernedMarketCall__Outputs(this);
  }
}

export class AddGovernedMarketCall__Inputs {
  _call: AddGovernedMarketCall;

  constructor(call: AddGovernedMarketCall) {
    this._call = call;
  }

  get addresses(): AddGovernedMarketCallAddressesStruct {
    return changetype<AddGovernedMarketCallAddressesStruct>(
      this._call.inputValues[0].value.toTuple()
    );
  }

  get params(): AddGovernedMarketCallParamsStruct {
    return changetype<AddGovernedMarketCallParamsStruct>(
      this._call.inputValues[1].value.toTuple()
    );
  }
}

export class AddGovernedMarketCall__Outputs {
  _call: AddGovernedMarketCall;
...
export class AddGovernedMarketCallAddressesStruct extends ethereum.Tuple {
  get owner(): Address {
    return this[0].toAddress();
  }
...
export class AddGovernedMarketCallParamsStruct extends ethereum.Tuple {
  get name(): Bytes {
    return this[0].toBytes();
  }
